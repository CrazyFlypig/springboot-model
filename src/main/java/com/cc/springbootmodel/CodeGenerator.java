...
import com.cc.springbootmodel.core.constant.ProjectConstant;
...
public class CodeGenerator {
    ...
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3307/check_data_service?serverTimezone=UTC";
    ...
    public static void main(String[] args) {
        //表名
        String tableName = "node_info";
        //注释
        String comment = "节点信息表";
     ...
     */
    public static void genCode(String tableName,String comment) {
        genModelAndMapper(tableName);
        genService(tableName);
        genController(tableName,comment);
    }
    ...
    public static void genController(String tableName,String comment) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
            Map<String, Object> data = new HashMap<>();
            data.put("date", DATE);
            ...
            data.put("basePackageService", ProjectConstant.SERVICE_PACKAGE);
            data.put("basePackageModel", ProjectConstant.MODEL_PACKAGE);
            data.put("tableChineseComment",comment);
